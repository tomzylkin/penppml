...
#trade_ids <- cbind(trade2, cross_ids)
#write_dta(trade_ids, "trade.dta")
```
...
set.seed(123)
bs1 <- bootstrap(data=trade3, dep="export",  cluster_id="clus", fixed=list(c("exp", "time"), c("imp", "time"), c("exp", "imp")), indep=c("ad_prov_14", "tbt_prov_07", "lm_prov_10"), bootreps=10, colcheck_x = TRUE, colcheck_x_fes = TRUE, boot_threshold = 0.01, post=TRUE, gamma_val=0.01, verbose=FALSE)
```
